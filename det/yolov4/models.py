...
class Yolov4Head(nn.Module):
    def __init__(self):
        ...
        self.conv2 = Conv_Bn_Activation(256, 147, 1, 1, 'linear', bn=False, bias=True)
        ...
        self.conv10 = Conv_Bn_Activation(512, 147, 1, 1, 'linear', bn=False, bias=True)
        ...
        self.conv18 = Conv_Bn_Activation(1024, 147, 1, 1, 'linear', bn=False, bias=True)
