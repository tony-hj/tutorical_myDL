...
def fit_ont_epoch(net,epoch,epoch_size,epoch_size_val,gen,genval,Epoch):
    ...
    torch.save(model.state_dict(), '/content/drive/My Drive/frcnn/Epoch%d-Total_Loss%.4f-Val_Loss%.4f.pth'%((epoch+1),total_loss/(epoch_size+1),val_toal_loss/(epoch_size_val+1)))
