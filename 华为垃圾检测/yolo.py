...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            print("label_id: %s, label_name: %s, score: %.2f, " % (c, predicted_class, score), "box:", (left, top), (right, bottom))
            ...
            draw.rectangle(
                ...
                fill=self.colors[c])
            draw.text(text_origin, '{}, {:.2f}'.format(str(c), score), fill=(0, 0, 0), font=font)
            del draw
        ...
        if out_boxes is not None:
            ...
            for class_id in out_classes:
                detection_class_names.append(self.class_names[int(class_id)])
            out_boxes_list = []
